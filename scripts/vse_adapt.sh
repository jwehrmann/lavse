...
--profile vse \
--outpath $OUT_PATH/lavse/vse/f30k_precomp.en_m30k_precomp.de_jap_precomp.jt/
...
--profile vse \
--outpath $OUT_PATH/lavse/vse/f30k_precomp.en_jap_precomp.jt/
...
--profile vse \
--outpath $OUT_PATH/lavse/vse/f30k_precomp.en_m30k_precomp.de/
...
--adapt_data jap_precomp.en-jt \
--profile vse \
--outpath $OUT_PATH/lavse/vse/coco_precomp.en_jap_precomp.jt/
